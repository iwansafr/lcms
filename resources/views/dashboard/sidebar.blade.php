<aside class="main-sidebar sidebar-dark-primary elevation-4">
	<a href="/AdminLte/index3.html" class="brand-link">
		{{-- <img src="/logo.png" class="img img-fluid" alt="logo"> --}}
		<img src="/small-icon.png" class="brand-image img-circle elevation-3" alt="icon">
		<span class="brand-text font-weight-light">esoftgreat</span>
	</a>
	<div class="sidebar">
								...
								@foreach ($value['child'] as $ckey => $cvalue)
									<li class="nav-item">
										<a href="{{$cvalue['link']}}" class="nav-link">
											<i class="@if(empty($cvalue['icon'])) far fa-circle @else {{$cvalue['icon']}} @endif nav-icon"></i>
											<p>{{$cvalue['title']}}</p>
										</a>
									</li>
								@endforeach
